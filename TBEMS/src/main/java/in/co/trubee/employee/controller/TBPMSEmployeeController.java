...
public class TBPMSEmployeeController {
	...
	public ResponseEntity<Optional<TBEMSEmployeeDomain>> getEmployeeById(@PathVariable(value = "id") Long employeeId)
    //throws ResourceNotFoundException
	{
		Optional<TBEMSEmployeeDomain> employee = employeeService.findById(employeeId);
